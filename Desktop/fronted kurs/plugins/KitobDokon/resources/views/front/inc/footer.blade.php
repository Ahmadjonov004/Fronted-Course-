    ...
    <div class="container">
        <div class="row">
            <div class="search-listing row">
                ...
                <div class="col-12">
                    <div class="listing-search-scroll">
                        @livewire('front.shop-card-component')
                    </div>
                </div>
            </div>
        </div>
...
<!-- JavaScript -->
<script src="/front/vendor/js/bundle.min.js"></script>
<!-- Plugin Js -->
<script src="https://cdn.jsdelivr.net/npm/swiper@11/swiper-element-bundle.min.js"></script>

<script src="/front/vendor/js/jquery.fancybox.min.js"></script>
<script src="/front/vendor/js/owl.carousel.min.js"></script>
<script src="/front/vendor/js/swiper.min.js"></script>
<script src="/front/vendor/js/jquery.cubeportfolio.min.js"></script>
<script src="/front/vendor/js/wow.min.js"></script>
<script src="/front/vendor/js/bootstrap-input-spinner.js"></script>
<script src="/front/vendor/js/parallaxie.min.js"></script>
<script src="/front/vendor/js/stickyfill.min.js"></script>
<script src="/front/book-shop/js/nouislider.min.js"></script>

<script src="/front/vendor/js/jquery.themepunch.tools.min.js"></script>
<script src="/front/vendor/js/jquery.themepunch.revolution.min.js"></script>
<!-- SLIDER REVOLUTION EXTENSIONS -->
<script src="/front/vendor/js/extensions/revolution.extension.actions.min.js"></script>
<script src="/front/vendor/js/extensions/revolution.extension.carousel.min.js"></script>
<script src="/front/vendor/js/extensions/revolution.extension.kenburn.min.js"></script>
<script src="/front/vendor/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script src="/front/vendor/js/extensions/revolution.extension.migration.min.js"></script>
<script src="/front/vendor/js/extensions/revolution.extension.navigation.min.js"></script>
<script src="/front/vendor/js/extensions/revolution.extension.parallax.min.js"></script>
<script src="/front/vendor/js/extensions/revolution.extension.slideanims.min.js"></script>
<script src="/front/vendor/js/extensions/revolution.extension.video.min.js"></script>

<!-- Custom Script -->
<script src="/front/book-shop/js/script.js"></script>
</body>
</html>
